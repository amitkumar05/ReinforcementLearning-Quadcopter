...
class RandomPolicySearch(BaseAgent):
    ...
    def __init__(self, task):
        ...
        print(self.task.action_space.high,self.task.action_space.low)
        print(self.task.observation_space.__repr__(),self.task.action_space)
        # Policy parameters
        ...
        self.render_env ='store_true'
        self.use_gym_monitor = 'store_true'
        self.monitor_dir ='./results/gym_ddpg'
        self.summary_dir ='./results/tf_ddpg'

        self.render_env = False
        self.use_gym_monitor = True
        
        pp.pprint(self.random_seed)
        ...
        self.state_dim = 7
        self.action_dim = 6
        self.action_bound = 25
        # print("Hello ",state_dim,action_dim,action_bound)
        ...
        self.replay_buffer = ReplayBuffer(int(self.buffer_size), int(self.random_seed))
    ...
    def step(self, state, reward, done):
        ...
        # print("STATE:" ,state,self.last_state)



# state_size
        action = self.actor.predict(np.reshape(state, (1, self.state_size))) + self.actor_noise()
        # print("action :",action)

        # s2, r, terminal, info = env.step(a[0])

        if self.last_state is not None:
            # self.replay_buffer.add(np.reshape(self.last_state, (self.state_dim,)), np.reshape(self.last_action, (self.action_dim,)), reward,
            #     done, np.reshape(state, (self.state_dim,)))
            ...
            ep_ave_max_q = 0
            if self.replay_buffer.size() > int(self.minibatch_size):
    ...
    def act(self, state):
        ...
        # print("AGENT: Inside Action " ,action)  # [debug: action vector]
        return action
    ...
    def learn(self):
        ...
        print("RandomPolicySearch.learn(): t = {:4d}, score = {:7.3f} (best = {:7.3f}), noise_scale = {}".format(
                self.count, score, self.best_score, self.total_reward)) #self.noise_scale))  # [debug]
        # print(self.total_reward)
        # with open("res_all.txt",'a') as file:
